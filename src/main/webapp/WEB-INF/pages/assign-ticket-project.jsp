...
<title>Assign ticket to project page</title>
<style>
...
<body>
<h2>Assign ticket to project page</h2>
<jsp:include page="header.jsp" />

<sec:authorize access="hasRole('ROLE_ADMIN')">
<p>Here you can assign ticket to project.</p>

<form:form method="POST" commandName="assignticketproject" action="${pageContext.request.contextPath}/assign-ticket-project.html">
...
<tbody>
	...
	<tr>
		  <td>
			<form:select style="color:dark; font-size:15px; height:36px; width:169px; border-radius:7px; border:2px solid #ccc; box-sizing: border-box; font-weight:bolder; color:#686868;" path="ticket.id" enctype="multipart/form-data">
				<option value="Select" label=" - Ticket - " ></option>
			       <form:options items="${ticketsList}" path="ticket_id" itemValue= "id" itemLabel= "nomTicket"></form:options>
			</form:select>  
	      </td>
	</tr>
